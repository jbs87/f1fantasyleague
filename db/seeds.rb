...
Driver.create!({ name: 'Fernando Alonso', price: 55000000, driverId: 'alonso',image_url: 'drivers/220px-Fernando_Alonso_Bahrain.jpg'  })
...
ChassisManufacturer.create!({ name: 'Mercedes GP Petronas F1', price: 55000000, constructorId: 'mercedes' })
ChassisManufacturer.create!({ name: 'Infiniti Red Bull Racing', price: 61750000, constructorId: 'red_bull' })
ChassisManufacturer.create!({ name: 'Williams F1 Team', price: 25000000, constructorId: 'williams' })
ChassisManufacturer.create!({ name: 'Scuderia Ferrari', price: 50000000, constructorId: 'ferrari' })
ChassisManufacturer.create!({ name: 'McLaren Mercedes', price: 40000000, constructorId: 'mclaren' })
ChassisManufacturer.create!({ name: 'Sahara Force India F1 Team', price: 30000000, constructorId: 'force_india' })
ChassisManufacturer.create!({ name: 'Scuderia Toro Rosso', price: 22000000, constructorId: 'toro_rosso' })
ChassisManufacturer.create!({ name: 'Lotus F1 Team', price: 35000000, constructorId: 'lotus_f1' })
ChassisManufacturer.create!({ name: 'Sauber F1 Team', price: 30000000, constructorId: 'sauber' })
ChassisManufacturer.create!({ name: 'Marussia F1 Team', price: 20000000, constructorId: 'marussia' })
ChassisManufacturer.create!({ name: 'Caterham F1 Team', price: 20000000, constructorId: 'caterham' })


Engine.create!({ name: 'Mercedes - Mercedes', price: 55000000, constructorId: 'mercedes' })
Engine.create!({ name: 'Red Bull - Renault', price: 61750000, constructorId: 'red_bull' })
Engine.create!({ name: 'Williams - Mercedes', price: 25000000, constructorId: 'williams' })
Engine.create!({ name: 'Ferrari - Ferrari', price: 50000000, constructorId: 'ferrari' })
Engine.create!({ name: 'McLaren - Mercedes', price: 40000000, constructorId: 'mclaren' })
Engine.create!({ name: 'Force India - Mercedes', price: 30000000, constructorId: 'force_india' })
Engine.create!({ name: 'Toro Rosso - Renault', price: 22000000, constructorId: 'toro_rosso' })
Engine.create!({ name: 'Lotus - Renault', price: 35000000, constructorId: 'lotus_f1' })
Engine.create!({ name: 'Sauber  Ferrari', price: 30000000, constructorId: 'sauber'  })
Engine.create!({ name: 'Marussia - Ferrari', price: 20000000, constructorId: 'marussia' })
Engine.create!({ name: 'Caterham - Renault', price: 20000000, constructorId: 'caterham' })
