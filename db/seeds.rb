...
RaceResult.create!({team_member_id: 2, qualifying_pos: 2, race_pos: 2, race_id: 1})
RaceResult.create!({team_member_id: 3, qualifying_pos: 3, race_pos: 3, race_id: 1})
RaceResult.create!({team_member_id: 4, qualifying_pos: 4, race_pos: 4, race_id: 1})
RaceResult.create!({team_member_id: 5, qualifying_pos: 5, race_pos: 5, race_id: 1})
RaceResult.create!({team_member_id: 6, qualifying_pos: 6, race_pos: 6, race_id: 1})
RaceResult.create!({team_member_id: 7, qualifying_pos: 7, race_pos: 7, race_id: 1})
RaceResult.create!({team_member_id: 8, qualifying_pos: 8, race_pos: 8, race_id: 1})
RaceResult.create!({team_member_id: 9, qualifying_pos: 9, race_pos: 9, race_id: 1})
RaceResult.create!({team_member_id: 10, qualifying_pos: 10, race_pos: 10, race_id: 1})
RaceResult.create!({team_member_id: 11, qualifying_pos: 11, race_pos: 11, race_id: 1})
RaceResult.create!({team_member_id: 12, qualifying_pos: 12, race_pos: 12, race_id: 1})
RaceResult.create!({team_member_id: 13, qualifying_pos: 13, race_pos: 13, race_id: 1})
RaceResult.create!({team_member_id: 14, qualifying_pos: 14, race_pos: 14, race_id: 1})
RaceResult.create!({team_member_id: 15, qualifying_pos: 15, race_pos: 15, race_id: 1})
RaceResult.create!({team_member_id: 16, qualifying_pos: 16, race_pos: 16, race_id: 1})
RaceResult.create!({team_member_id: 17, qualifying_pos: 17, race_pos: 17, race_id: 1})
RaceResult.create!({team_member_id: 18, qualifying_pos: 18, race_pos: 18, race_id: 1})
RaceResult.create!({team_member_id: 19, qualifying_pos: 19, race_pos: 19, race_id: 1})
RaceResult.create!({team_member_id: 20, qualifying_pos: 20, race_pos: 20, race_id: 1})
RaceResult.create!({team_member_id: 21, qualifying_pos: 21, race_pos: 21, race_id: 1})
RaceResult.create!({team_member_id: 22, qualifying_pos: 22, race_pos: 22, race_id: 1})
RaceResult.create!({team_member_id: 23, qualifying_pos: 1, race_pos: 6, race_id: 2})
RaceResult.create!({team_member_id: 24, qualifying_pos: 2, race_pos: 5, race_id: 2})
RaceResult.create!({team_member_id: 25, qualifying_pos: 3, race_pos: 4, race_id: 2})
RaceResult.create!({team_member_id: 26, qualifying_pos: 4, race_pos: 3, race_id: 2})
RaceResult.create!({team_member_id: 27, qualifying_pos: 5, race_pos: 2, race_id: 2})
RaceResult.create!({team_member_id: 28, qualifying_pos: 6, race_pos: 1, race_id: 2})
RaceResult.create!({team_member_id: 29, qualifying_pos: 7, race_pos: 7, race_id: 2})
RaceResult.create!({team_member_id: 30, qualifying_pos: 8, race_pos: 8, race_id: 2})
RaceResult.create!({team_member_id: 31, qualifying_pos: 9, race_pos: 9, race_id: 2})
RaceResult.create!({team_member_id: 32, qualifying_pos: 10, race_pos: 10, race_id: 2})
RaceResult.create!({team_member_id: 33, qualifying_pos: 11, race_pos: 11, race_id: 2})
RaceResult.create!({team_member_id: 34, qualifying_pos: 12, race_pos: 12, race_id: 2})
RaceResult.create!({team_member_id: 35, qualifying_pos: 13, race_pos: 13, race_id: 2})
RaceResult.create!({team_member_id: 36, qualifying_pos: 14, race_pos: 14, race_id: 2})
RaceResult.create!({team_member_id: 37, qualifying_pos: 15, race_pos: 15, race_id: 2})
RaceResult.create!({team_member_id: 38, qualifying_pos: 16, race_pos: 16, race_id: 2})
RaceResult.create!({team_member_id: 39, qualifying_pos: 17, race_pos: 17, race_id: 2})
RaceResult.create!({team_member_id: 40, qualifying_pos: 18, race_pos: 18, race_id: 2})
RaceResult.create!({team_member_id: 41, qualifying_pos: 19, race_pos: 19, race_id: 2})
