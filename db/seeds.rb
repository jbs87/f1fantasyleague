...
Chasis.create!({ name: 'Mercedes Grand Prix', price: 0 })
Chasis.create!({ name: 'Red Bull', price: 0 })
Chasis.create!({ name: 'Williams', price: 0 })
Chasis.create!({ name: 'Ferrari', price: 0 })
Chasis.create!({ name: 'McLaren', price: 0 })
Chasis.create!({ name: 'Force India F1', price: 0 })
Chasis.create!({ name: 'Scuderia Toro Rosso', price: 0 })
Chasis.create!({ name: 'Lotus Renault', price: 0 })
Chasis.create!({ name: 'Sauber', price: 0 })
Chasis.create!({ name: 'Marussia', price: 0 })
Chasis.create!({ name: 'Caterham', price: 0 })
